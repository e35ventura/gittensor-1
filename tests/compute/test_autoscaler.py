...
def test_funding_shortfall_does_not_make_target_grow_without_new_demand():
    ...
    scaler.update(active_slots=16, rejected_concurrent_demand=0, funded_target=4, now=0)
    first = scaler.update(active_slots=16, rejected_concurrent_demand=0, funded_target=4, now=1)
    assert first.desired_target == 6

    scaler.update(active_slots=16, rejected_concurrent_demand=0, funded_target=4, now=2)
    stable = scaler.update(active_slots=16, rejected_concurrent_demand=0, funded_target=4, now=3)
